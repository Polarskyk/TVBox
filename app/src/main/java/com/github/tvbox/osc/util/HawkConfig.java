...
public class HawkConfig {
    ...
    // 启动时一次性引导（申请 root / 设置默认桌面）
    public static final String STARTUP_ROOT_PROMPTED = "startup_root_prompted";
    public static final String STARTUP_HOME_PROMPTED = "startup_home_prompted";
